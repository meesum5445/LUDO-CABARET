...
{
	this->local_path[destination.path_index].push_back(this->local_path[source.path_index][source.floor]);
	this->local_path[source.path_index].erase(this->local_path[source.path_index].begin() + source.floor);				// make source empty by erasing
