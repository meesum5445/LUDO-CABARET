...
{
	this->path[destination.path_index].push_back(this->path[source.path_index][source.floor]);	
	this->path[source.path_index].erase(this->path[source.path_index].begin() + source.floor);				// make source empty by erasing
